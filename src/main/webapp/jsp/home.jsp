...
Author: 
	...
	****** Ong Thi Diem Phuc       - 15110280 ******
-->
<html>
<head>
<title>YSURIA HOMEPAGE</title>
<meta charset="utf-8">
<meta name="viewport"
...
<body id="top">
	...
	<div class="wrapper row0">
		<div id="topbar" class="hoc clear">
			...
			<div class="fl_left">
				<ul class="nospace">
					<li><i class="fa fa-phone"></i> +84 989297550</li>
					<li><i class="fa fa-envelope-o"></i> <a>nhuytnt0816@gmail.com</a></li>
				</ul>
			</div>
			<div class="fl_right">
				<ul class="nospace">
	...
	<div class="wrapper row3">
		...
		<div class="sidebar one_quarter first">
			...
			<div class="sdb_holder">
				<h6>Links</h6>
				<ul>
					<li><a href="http://sac.hcmute.edu.vn/">Student Assistance
							Center</a></li>
					<li><a href="http://fit.hcmute.edu.vn/">Faculty Of
							Information Technology</a></li>
					<li><a href="http://pr.hcmute.edu.vn/">Public Relations</a></li>
				</ul>
			</div>
			<!-- ################################################################################################ -->
		</div>
		...
		<div class="content three_quarter">
			<!-- ################################################################################################ -->
			<h1 class="center">WELCOME TO YSURIA 2016</h1>
			<div>
	...
	<div class="wrapper row4 bgded overlay"
		...
		<footer id="footer" class="hoc clear">
			...
			<div class="one_quarter first">
				<h6 class="title">YSURIA Mission</h6>
			...
			<div class="one_quarter">
				<h6 class="title">YSURIA Vision</h6>
			...
			<div class="one_quarter">
				...
				<ul class="nospace linklist contact">
					<li><i class="fa fa-map-marker"></i>
						<address>01 Vo Van Ngan - Linh Chieu - Thu Duc- HCMC</address></li>
					<li><i class="fa fa-phone"></i> +84 898297053</li>
					<li><i class="fa fa-envelope-o"></i> <a
						href="https://www.facebook.com/diemphuc.suria" target="_blank">fb.com/diemphuc.suria</a></li>
					<li><i class="fa fa-envelope-o"></i> <a
						href="https://www.facebook.com/yzenny97" target="_blank">fb.com/yzenny97</a></li>
				</ul>
			</div>
			<div class="one_quarter">
				<h6 class="title">link</h6>
				<a href="https://phanlamcoder.blogspot.com/p/home-page_5.html"
					target="_blank">Our Blog</a><br /> <a
					href="https://www.youtube.com/channel/UCtPVEDDWKVQmA65HHQk3O5Q/videos"
	...
	<div class="wrapper row5">
		<div id="copyright" class="hoc clear">
			<!-- ################################################################################################ -->
			<p class="fl_left">Copyright © 2018, ZENNY GROUP</p>
